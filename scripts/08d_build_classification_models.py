...
Usage:
    python scripts/08d_build_classification_models.py                         # all FPs, random split
    python scripts/08d_build_classification_models.py --fp maccs              # single FP
    python scripts/08d_build_classification_models.py --split kennard_stone   # KS split
    python scripts/08d_build_classification_models.py --tier 1                # only fast models
    python scripts/08d_build_classification_models.py --tier 1-2              # fast + medium
    python scripts/08d_build_classification_models.py --mode balanced         # only balanced mode
"""
...
OUTPUT_DIR_DEFAULT = os.path.join(_DIR, "..", "data", "models_classification_decorrelated")
OUTPUT_DIR_BALANCED = os.path.join(_DIR, "..", "data", "models_classification_balanced_decorrelated")
ZIP_DIR = os.path.join(_DIR, "..", "data", "models_classification_decorrelated_zips")
...
def zip_model_results(model_name, fp_name, split_name, output_dir, mode_label):
    ...
    zip_name = f"08d_{fp_name}_{split_name}_{mode_label}_{safe_name}.zip"
...
def main():
    ...
    print("=" * 70)
    print(f"Classification Models (08d — Decorrelated) — {tier_label}")
    print("=" * 70)
