...
Usage:
    python scripts/07b_build_models.py                    # all 16 models (resumable)
    python scripts/07b_build_models.py --batch 1          # only model #1
    python scripts/07b_build_models.py --batch 5          # only model #5
    python scripts/07b_build_models.py --batch 1-5        # models 1-5
    python scripts/07b_build_models.py --fp maccs --split random   # (default)
"""
...
OUTPUT_DIR = os.path.join(_DIR, "..", "data", "models_decorrelated")
